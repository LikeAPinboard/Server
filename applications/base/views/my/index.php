<?php echo $this->partial("partial/header");?>
        ...
        <section class="lap-content">
            ...
            <div class="lap-account pure-g">
                <div class="pure-u-2-3">
                    <a href="<?php echo ( ! $user->facebook_id ) ? page_link("signin/facebook?c=1") : "#";?>" class="pure-button lap-account-button lap-account-github<?php echo ( $user->github_id ) ? " disabled" : "";?>">
